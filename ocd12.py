...
class Ocd12(KaitaiStruct):
    ...
    class TStringIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(256):
                self.string_table[i] = Ocd12.TStringIndex(self._io, self, self._root)
    ...
    class TSymbolIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(256):
                self.symbol_position[i] = Ocd12.TSymbolPos(self._io, self, self._root)
    ...
    class TObjectIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(256):
                self.object_table[i] = Ocd12.TObjectIndex(self._io, self, self._root)
    ...
    class TObjectIndex(KaitaiStruct):
        ...
        def _read(self):
            self.rc = [None] * (2)
            for i in range(2):
                self.rc[i] = Ocd12.TDPoly(self._io, self, self._root)
        ...
        def _read(self):
            ...
            if  ((self.n_item != 0) and (self.otp.value != 1)) :
                ...
                for i in range(self.n_item):
                    self.poly[i] = Ocd12.TDPoly(self._io, self, self._root)
            ...
            if  ((self.n_item > 1) and (self.otp.value == 1)) :
                ...
                for i in range((self.n_item - 1)):
                    self.cut_angles[i] = Ocd12.PointSymbolCutAngle(self._io, self, self._root)
