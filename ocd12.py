...
class Ocd12(KaitaiStruct):
    ...
    def _read(self):
        self.file_header = Ocd12.OcdFileHeader(self._io, self, self._root)
    ...
    class TTextSymbol(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.font_name = Ocd12.PascalString(_io__raw_font_name, self, self._root)
    ...
    class TSymbolBase(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.otp = KaitaiStream.resolve_enum(Ocd12.EObjEtSymTypes, self._io.read_u1())
    ...
    class TSymElt(KaitaiStruct):
        ...
        def _read(self):
            self.st_type = KaitaiStream.resolve_enum(Ocd12.ESymbolElementType, self._io.read_u2le())
            ...
            self.st_poly = Ocd12.TSymElementPoly(_io__raw_st_poly, self, self._root)
    ...
    class TAreaSymbol(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.hatch_mode = KaitaiStream.resolve_enum(Ocd12.EAreaHatchMode, self._io.read_u2le())
            ...
            self.struct_mode = KaitaiStream.resolve_enum(Ocd12.EAreaStructMode, self._io.read_u1())
            self.struct_draw = KaitaiStream.resolve_enum(Ocd12.EStructDrawingMode, self._io.read_u1())
            ...
            if self.data_size > 0:
                ...
                self.elements = Ocd12.TSymElements(_io__raw_elements, self, self._root)
    ...
    class TSymbolPos(KaitaiStruct):
        ...
        def symbol(self):
            ...
            if self.pos > 0:
                ...
                _pos = io.pos()
                io.seek(self.pos)
                self._m_symbol = Ocd12.TSymbol(io, self, self._root)
                io.seek(_pos)
    ...
    class TLineSymbol(KaitaiStruct):
        ...
        def _read(self):
            ...
            if self.prim_dsize > 0:
                ...
                self.prim_elements = Ocd12.TSymElements(_io__raw_prim_elements, self, self._root)
            ...
            if self.sec_dsize > 0:
                ...
                self.sec_elements = Ocd12.TSymElements(_io__raw_sec_elements, self, self._root)
            ...
            if self.corner_dsize > 0:
                ...
                self.corner_elements = Ocd12.TSymElements(_io__raw_corner_elements, self, self._root)
            ...
            if self.start_dsize > 0:
                ...
                self.start_elements = Ocd12.TSymElements(_io__raw_start_elements, self, self._root)
            ...
            if self.end_dsize > 0:
                ...
                self.end_elements = Ocd12.TSymElements(_io__raw_end_elements, self, self._root)
    ...
    class TSymElementPoly(KaitaiStruct):
        ...
        def _read(self):
            ...
            while not self._io.is_eof():
                self.entries.append(Ocd12.TDPoly(self._io, self, self._root))
                i += 1
    ...
    class TSymElements(KaitaiStruct):
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.entries.append(Ocd12.TSymElt(self._io, self, self._root))
                i += 1
    ...
    class TStringIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.string_table = []
            for i in range(256):
                self.string_table.append(Ocd12.TStringIndex(self._io, self, self._root))
        ...
        def next(self):
            ...
            if self.next_index_block != 0:
                ...
                self._m_next = Ocd12.TStringIndexBlock(io, self, self._root)
                io.seek(_pos)
    ...
    class TSymbolIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            for i in range(256):
                self.symbol_position.append(Ocd12.TSymbolPos(self._io, self, self._root))
        ...
        def next(self):
            ...
            if self.next_index_block != 0:
                ...
                _pos = io.pos()
                io.seek(self.next_index_block)
                self._m_next = Ocd12.TSymbolIndexBlock(io, self, self._root)
                io.seek(_pos)
    ...
    class OcdFileHeader(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.file_type = KaitaiStream.resolve_enum(Ocd12.EFileType, self._io.read_u1())
    ...
    class TObjectIndexBlock(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.object_table = []
            for i in range(256):
                self.object_table.append(Ocd12.TObjectIndex(self._io, self, self._root))
        ...
        def next(self):
            ...
            if self.next_index_block != 0:
                ...
                _pos = io.pos()
                io.seek(self.next_index_block)
                self._m_next = Ocd12.TObjectIndexBlock(io, self, self._root)
                io.seek(_pos)
    ...
    class TObjectIndex(KaitaiStruct):
        ...
        def _read(self):
            self.rc = []
            for i in range(2):
                self.rc.append(Ocd12.TDPoly(self._io, self, self._root))

            self.pos = self._io.read_u4le()
            self.len = self._io.read_u4le()
            self.sym = self._io.read_s4le()
            self.obj_type = KaitaiStream.resolve_enum(Ocd12.EObjEtSymTypes, self._io.read_u1())
            self.encrypted_mode = self._io.read_u1()
            self.status = KaitaiStream.resolve_enum(Ocd12.EObjectStatus, self._io.read_u1())
            self.view_type = KaitaiStream.resolve_enum(Ocd12.EObjectViewMode, self._io.read_u1())
        ...
        def object(self):
            ...
            self._m_object = Ocd12.TElement(_io__raw__m_object, self, self._root)
            self._io.seek(_pos)
    ...
    class TSymbol(KaitaiStruct):
        ...
        def _read(self):
            self.base = Ocd12.TSymbolBase(self._io, self, self._root)
            _on = self.base.otp
            if _on == Ocd12.EObjEtSymTypes.text:
                self.type_specific = Ocd12.TTextSymbol(self._io, self, self._root)
            elif _on == Ocd12.EObjEtSymTypes.line_text:
                self.type_specific = Ocd12.TLineTextSymbol(self._io, self, self._root)
            elif _on == Ocd12.EObjEtSymTypes.rectangle:
                self.type_specific = Ocd12.TRectangleSymbol(self._io, self, self._root)
            elif _on == Ocd12.EObjEtSymTypes.line:
                self.type_specific = Ocd12.TLineSymbol(self._io, self, self._root)
            elif _on == Ocd12.EObjEtSymTypes.area:
                self.type_specific = Ocd12.TAreaSymbol(self._io, self, self._root)
            elif _on == Ocd12.EObjEtSymTypes.point:
                self.type_specific = Ocd12.TPointSymbol(self._io, self, self._root)
    ...
    class TElement(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.object_string_type = KaitaiStream.resolve_enum(Ocd12.EObjectStringType, self._io.read_u1())
            self.reserved2 = self._io.read_bytes(1)
            if  ((self.n_item != 0) and (self.otp.value != 1)) :
                self.poly = []
                for i in range(self.n_item):
                    self.poly.append(Ocd12.TDPoly(self._io, self, self._root))


            if self.otp.value == 1:
                self.center = Ocd12.TDPoly(self._io, self, self._root)

            if  ((self.n_item > 1) and (self.otp.value == 1)) :
                self.cut_angles = []
                for i in range((self.n_item - 1)):
                    self.cut_angles.append(Ocd12.PointSymbolCutAngle(self._io, self, self._root))
    ...
    class TRectangleSymbol(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.unnum_text = Ocd12.PascalString(_io__raw_unnum_text, self, self._root)
            self.line_style = self._io.read_u2le()
    ...
    def symbol_index(self):
        ...
        self._m_symbol_index = Ocd12.TSymbolIndexBlock(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def string_index(self):
        ...
        self._m_string_index = Ocd12.TStringIndexBlock(self._io, self, self._root)
        self._io.seek(_pos)
    ...
    def object_index(self):
        ...
        self._m_object_index = Ocd12.TObjectIndexBlock(self._io, self, self._root)
        self._io.seek(_pos)
